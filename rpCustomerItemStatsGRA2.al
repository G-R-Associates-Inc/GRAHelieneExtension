...
*   12/17/2019 - Lina El Sadek, G.R. & Associates Inc.
*              - This report is the same as NAV's 10048. Grouping is done as Customer, Sales Order, and then Item No. 
*/       
report 58002 "GRA Customer/Item Statistics 2"
{
    CaptionML=ENU='Customer/Item Statistics 2',
               ESM='Estad. cliente/producto 2',
               FRC='Statistiques client/article 2',
               ENC='Customer/Item Statistics 2';
  
    DefaultLayout=RDLC;
    RDLCLayout='./GRACustomerItemStatistics2.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
                ...
                dataitem("Value Entry"; "Value Entry")
                {
                    ...
                    DataItemTableView=SORTING("Source Type","Source No.","Document No.","Item Ledger Entry Type","Item No.","Posting Date")
    ...
    BEGIN
        ...
        ExcelBuf.AddInfoColumn(REPORT::"GRA Customer/Item Statistics 2",FALSE,FALSE,FALSE,FALSE,'',ExcelBuf."Cell Type"::Number);
        ExcelBuf.NewRow;
