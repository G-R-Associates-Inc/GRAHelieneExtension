...
*   GRALE01 - 10/10/19 - Lina El Sadek, G.R. & Associates Inc.
            - Version Tag GRA1.02
*           - Created the table to act as a placeholder for all the information we want to expose in Salesperson Web Portal.
*           - This table is a copy of table 58000, but the keys are different. We went through this route because destructive schema
*           - is not supported in UpdateMode=Synchronize. The only workaround is to 'clean remove' the extension and thereby deleting all data related to it.
**/

table 58001 "Sales Info Placeholder 2"
{
    fields
    {
    ...
    keys
    {
        key(Key1; "Document No.", "Document Type", "Company Name", "Line No."){}
